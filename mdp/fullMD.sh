...
/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/em-vac-pme.mdp -c $1-PBC.gro -p $1.top -o em-vac.tpr
...
/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/em-sol-pme.mdp -c $1-b4ion.gro -p $1.top -o ion.tpr
echo 13 | /scratch/msmaoui/gromacs/bin/genion -s ion.tpr -o $1-b4em.gro -neutral -conc 0.15 -p $1.top -g ion.log

/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/em-sol-pme.mdp -c $1-b4em.gro -p $1.top -o em-sol.tpr
/scratch/msmaoui/gromacs/bin/mdrun -v -deffnm em-sol

/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/nvt-pr-md.mdp -c em-sol.gro -p $1.top -o nvt-pr.tpr
/scratch/msmaoui/gromacs/bin/mdrun -deffnm nvt-pr

/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/npt-pr-md.mdp -c em-sol.gro -p $1.top -o npt-pr.tpr
/scratch/msmaoui/gromacs/bin/mdrun -deffnm npt-pr

/scratch/msmaoui/gromacs/bin/grompp -f /scratch/msmaoui/FibrilMutant/Amylin/mdp/npt-nopr-md.mdp -c em-sol.gro -p $1.top -o npt-nopr.tpr
